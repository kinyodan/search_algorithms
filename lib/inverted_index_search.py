...
class InvertedIndexSearch:
    def __init__(self, file_path: str,file_content: str) -> None:
        ...
        Args:
            file_path (str): The path to the file containing the text to be indexed.
        """
    ...
    def build_inverted_index(self) -> Optional[Dict[str, List[int]]]:
        ...
        Returns:
            Optional[Dict[str, List[int]]]: A dictionary mapping words to their indices in the file.
    ...
    def search(self, target_string: str) -> bool:
        ...
        Returns:
            bool: True if the target string is found in the index, False otherwise.
        """
